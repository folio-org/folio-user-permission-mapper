...
class RolesAbstractWorksheet(AbstractWorksheet):
    ...
    _columns = [
        ...
        Column[AnalyzedRole](w=14, n="Excluded", f=lambda x: False),
        Column[AnalyzedRole](w=60, n="Description", f=lambda x: x.role.description),
        Column[AnalyzedRole](w=22, n="# of Users", f=lambda x: x.assignedUsersCount),
        Column[AnalyzedRole](w=22, n="# of PS", f=lambda x: x.permissionsCount),
        Column[AnalyzedRole](w=22, n="# of Flat PS", f=lambda x: x.flatPermissionsCount),
        Column[AnalyzedRole](w=22, n="# of Total PS", f=lambda x: x.totalPermissionsCount),
    ]
