...
class MigrationResultWorksheet(AbstractWorksheet):
    ...
    _columns = [
        Column[EntityMigrationResult](w=40, n="Entity Id", f=lambda x: x.entityId),
        Column[EntityMigrationResult](w=15, n="Entity Name", f=lambda x: x.entityName),
        Column[EntityMigrationResult](w=18, n="Status", f=lambda x: x.status),
        Column[EntityMigrationResult](w=30, n="Reason", f=lambda x: x.reason),
