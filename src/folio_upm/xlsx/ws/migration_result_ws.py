...
class MigrationReportWorksheet(AbstractWorksheet):
    ...
    _columns = [
        Column[HttpRequestResult](w=80, n="Src Id", f=lambda x: x.srcEntityId),
        Column[HttpRequestResult](w=25, n="Src Name", f=lambda x: x.srcEntityName),
        Column[HttpRequestResult](w=25, n="Src Display Name", f=lambda x: x.srcEntityDisplayName),
        Column[HttpRequestResult](w=25, n="Target Name", f=lambda x: x.tarEntityName),
        Column[HttpRequestResult](w=25, n="Target Id", f=lambda x: x.tarEntityId),
        Column[HttpRequestResult](w=25, n="Target Display Name Id", f=lambda x: x.tarEntityId),
        Column[HttpRequestResult](w=18, n="Status", f=lambda x: x.status),
        Column[HttpRequestResult](w=40, n="Reason", f=lambda x: x.reason),
